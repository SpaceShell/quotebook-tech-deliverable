...
export function Message({postedDate, submitted}) {
    ...
    // return(
    //     <div className="md:flex md:flex-wrap md:justify-center px-10 md:px-28 gap-x-16 mb-10">
	// 		{data ? (
	// 			data.quotes.map((data, i) => (
	// 				<div key={i} className="mt-10 shadow-[0_1px_3px_3px_rgb(0,0,0,0.1),_0_5px_2px_-2px_rgb(0,0,0,0.1)] rounded-xl px-10 py-4 basis-1/3 grow">
	// 					<p>"{data.message}"</p>
